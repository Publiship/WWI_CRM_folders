<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="voyage_search.aspx.cs" Inherits="voyage_search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderM1" Runat="Server">
    ...
    <div class="container_16">
        ...
        <div class="grid_10 pad_bottom">
            <div class="divleft">
                <dx:ASPxLabel ID="dxlblSearch1" runat="server" 
                             ClientInstanceName="lblSearch1" 
                             CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
        ...
        <div class="grid_16 pad_bottom">
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridVoyage" ClientInstanceName="gridVoyage" 
                runat="server" AutoGenerateColumns="False" 
                CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                CssPostfix="Office2010Blue" width="100%" 
                DataSourceID="linqSearch" KeyFieldName="VoyageID" 
                onafterperformcallback="dxgridVoyage_AfterPerformCallback" 
                oncustombuttoncallback="dxgridVoyage_CustomButtonCallback">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="VoyageID" ReadOnly="True" Visible="False" 
                        VisibleIndex="0" Width="0px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Voyage number" FieldName="VoyageNumber" 
                        Name="colVoyageNumber" VisibleIndex="3" Width="130px">
                        <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Voyage" FieldName="Joined" Name="colJoined" 
                        VisibleIndex="1" Width="300px">
                        <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="Date added" FieldName="DateAdded" 
                        Name="colDateAdded" VisibleIndex="5" Width="100px">
    ...
    <dx:LinqServerModeDataSource ID="linqSearch" runat="server" 
        ContextTypeName="linq.linq_voyageDataContext" 
