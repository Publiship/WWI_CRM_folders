<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="housebl_search.aspx.cs" Inherits="housebl_search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderM1" Runat="Server">
    ...
    <div class="container_16">
        ...
        <div class="grid_10 pad_bottom">
            <div class="divleft">
                <dx:ASPxLabel ID="dxlblContainerDetails" runat="server" 
                    ...
                    Text="Search House bill of lading">
                         </dx:ASPxLabel>
            </div> 
            <div class="divleft">
        ...
        <div class="grid_16 pad_bottom">
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridHouseBL" ClientInstanceName="gridHouseBL" 
                runat="server" AutoGenerateColumns="False" 
                CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                CssPostfix="Office2010Blue" width="100%" 
                DataSourceID="linqSearch" KeyFieldName="HouseBLID" 
                onafterperformcallback="dxgridHouseBL_AfterPerformCallback" 
                oncustombuttoncallback="dxgridHouseBL_CustomButtonCallback">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="HouseBLID" Name="colHouseBLID" 
                        ReadOnly="True" Visible="False" VisibleIndex="0" Width="0px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="HBL number" 
                        FieldName="HouseBLNumber" Name="colHouseBLNumber" VisibleIndex="1" 
                        Width="250px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="HBL date" FieldName="HBLDate" 
                        Name="colHBLDate" VisibleIndex="4" Width="100px">
                    ...
                    <dx:GridViewDataDateColumn Caption="ETA" FieldName="ETA" 
                        Name="colETA" VisibleIndex="10" Width="100px">
                        <PropertiesDateEdit Spacing="0">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                </Columns>
    ...
    <dx:LinqServerModeDataSource ID="linqSearch" runat="server" 
        ContextTypeName="linq.linq_houseblDataContext" 
        TableName="HouseBLTables" />
