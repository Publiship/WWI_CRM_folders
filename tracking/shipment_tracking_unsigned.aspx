<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shipment_tracking_unsigned.aspx.cs" MasterPageFile="~/WWI_m1.master" Inherits="shipment_tracking_unsigned" %>
...
<script type="text/javascript">
    ...
    //deprecated as there is no way to identify a custom button in htmlrowcreated!
    //custom command buttons get order number
    function grid_CustomButtonClick(s, e) {
        e.processOnServer = false;

        var user = verify_user();
        if (user != 'You are not signed in') {
            if (e.buttonID == 'btnfiles') {
                //var window = popDefault.GetWindowByName('sysna');
                //popDefault.ShowWindow(window);
                //just use order number
                s.GetRowValues(s.GetFocusedRowIndex(), 'OrderNumber', ongridCommandFiles);
                //s.GetRowValues(s.GetFocusedRowIndex(), 'OrderNumber;TitleID', ongridCommandFiles);
            }
        }
        else {
            //var window = popDefault.GetWindowByName('sysna');
        ...
        <div class="innertube">  <!-- just a container div --> 
                                             ...
                                             <div class="row minheight45">
                                                ...
                                                <span class="left195 pad">
                                                      <dx:ASPxComboBox ID="dxcboclosedyn" runat="server" AutoPostBack="True" 
                                                                ...
                                                                Width="150px" Spacing="0" ClientEnabled="False">
                                                                <Items>
                                                ...
                                                <span class="left250 pad">
                                                   <dx:ASPxComboBox ID="cboName" runat="server" AutoPostBack="True" 
                                                                ...
                                                                Width="220px" Spacing="0" ClientEnabled="False" Enabled="False">
                                                                <LoadingPanelImage Url="~/App_Themes/Office2010Blue/Editors/Loading.gif">
                                                                </LoadingPanelImage>
                                                                <LoadingPanelStyle ImageSpacing="5px">
                                                                </LoadingPanelStyle>
                                                ...
                                                <span class="left pad">
                                                  <dx:ASPxButton ID="aspxbtnInfo0" runat="server" AutoPostBack="False" 
                                                     ...
                                                     ClientEnabled="False" Enabled="False">
                                                                <ClientSideEvents Click="function(s, e) {
	                                                                btndemo_Click(1);
                                                                }" />
                                            ...
                                            <div class="row minheight45">
                                                ...
                                                <span class="left195 pad">
                                                   <dx:ASPxButton ID="btnReport" runat="server" Text="Status report" UseSubmitBehavior="False" 
                                                    ...
                                                    VerticalAlign="Middle" TabIndex="10" ClientEnabled="False" 
                                                    Enabled="False" >
                                                ...
                                                <span class="left195 pad">
                                                    ...
                                                    CssPostfix="Office2010Blue" HorizontalAlign="Left" 
                                                    SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                                    Width="150px" ClientEnabled="False" Enabled="False">
            ...
            <!-- grid --->
              <dx:ASPxGridView ID="gridOrder" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                ...
                EnableViewState="False" onhtmlrowcreated="gridOrder_HtmlRowCreated" 
                onrowcommand="gridOrder_RowCommand" KeyFieldName="OrderIx" >
                    ...
                    <SettingsEditing EditFormColumnCount="3" Mode="PopupEditForm" PopupEditFormWidth="600px" />
                     <Columns>
                           <dx:GridViewDataTextColumn FieldName="OrderNumber" VisibleIndex="0" 
                            Caption="Order #" ReadOnly="True" Width="90px" Name="col_ordernumber">
                        </dx:GridViewDataTextColumn>
                         <dx:GridViewDataColumn Caption="Files" VisibleIndex="1" Width="45px" ExportWidth="0"  
                                ...
                                <DataItemTemplate>
                                    <dx:ASPxButton ID="dxbtnDocs" ClientInstanceName="btnDocs" runat="server" Text="" Image-Url="~/Images/icons/16x16/download.png" Image-AlternateText="Click here to see documents" AutoPostBack="false" CausesValidation="false" Cursor="pointer" EnableDefaultAppearance="False">
                                    </dx:ASPxButton>
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            
                        <dx:GridViewDataTextColumn FieldName="Title" VisibleIndex="2" 
                            Caption="Title" ReadOnly="True" Width="190px" Name="col_title" 
                               ExportWidth="80">
                            <Settings ShowFilterRowMenu="True" ShowInFilterControl="True" 
                                AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="HouseBLNUmber" VisibleIndex="3" 
                        ...
                        <dx:GridViewDataTextColumn FieldName="OtherRef" VisibleIndex="5" 
                            Caption="Other Ref" ReadOnly="True" Width="110px" 
                             Name="col_otherref" ExportWidth="70">
                            <Settings ShowFilterRowMenu="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn FieldName="origin_port" VisibleIndex="7" 
                            Caption="Origin Port" ReadOnly="True" Width="100px" Name="col_origin" 
                                 ExportWidth="80">
                            <Settings ShowFilterRowMenu="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn FieldName="ETS" VisibleIndex="8" 
                        ...
                        <dx:GridViewDataTextColumn FieldName="destination_port" VisibleIndex="9" 
                            Caption="Destination Port" ReadOnly="True" Width="120px" Name="col_dest" 
                                 ExportWidth="80">
                            <Settings ShowFilterRowMenu="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn FieldName="ETA" VisibleIndex="10" Caption="ETA" 
                            ReadOnly="True" Width="90px" Name="col_eta" ExportWidth="75">
                            <PropertiesDateEdit DisplayFormatString="{0:d}" Spacing="0">
                            </PropertiesDateEdit>
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn FieldName="destination_place" VisibleIndex="11" 
                            Caption="Final Destination" Width="190px" Name="col_final" ExportWidth="90">
                            <Settings ShowFilterRowMenu="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="ContainerNumber" VisibleIndex="12" Caption="Container #" 
                        ...
                        <dx:GridViewDataTextColumn Caption="Ex-Works date" FieldName="ExWorksDate" ReadOnly="True" 
                            VisibleIndex="13" Width="100px" Name="col_exworks" ExportWidth="75">
                            <PropertiesTextEdit DisplayFormatString="{0:d}">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ISBN" FieldName="ISBN" ReadOnly="True" 
                            VisibleIndex="14" Width="100px" Name="col_isbn" ExportWidth="70">
                            <Settings AutoFilterCondition="Contains" ShowFilterRowMenu="True" />
                        </dx:GridViewDataTextColumn>
                          <dx:GridViewDataTextColumn FieldName="PONumber" VisibleIndex="15" 
                            Caption="PO Number" ReadOnly="True" Width="110px" 
                             Name="col_ponumber" ExportWidth="70">
                            <Settings ShowFilterRowMenu="True" AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="ContactName" VisibleIndex="16" 
                             Caption="Contact Name" Name="col_contact" ReadOnly="True" 
                             Width="150px" ExportWidth="75">
                            <Settings AutoFilterCondition="Contains" ShowFilterRowMenu="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CompanyName" VisibleIndex="17" 
                             Caption="Customer" Name="col_company" ReadOnly="True" 
                             Width="150px" ExportWidth="75">
                            <Settings AutoFilterCondition="Contains" ShowFilterRowMenu="True" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Name" VisibleIndex="18" 
                         ...
                         <dx:GridViewDataDateColumn Caption="ETW" FieldName="ETW" Name="col_etw" 
                             ReadOnly="True" VisibleIndex="19" Width="90px" ExportWidth="75">
                             <PropertiesDateEdit DisplayFormatString="{0:d}" Spacing="0">
                             </PropertiesDateEdit>
                         </dx:GridViewDataDateColumn>
                         <dx:GridViewDataTextColumn Caption="Printer" FieldName="printer_name" 
                             ReadOnly="True" VisibleIndex="20" Width="150px" ExportWidth="90" 
                               Name="col_printer">
                             <Settings AutoFilterCondition="Contains" ShowFilterRowMenu="True" />
                         </dx:GridViewDataTextColumn>
                       
                        <dx:GridViewDataDateColumn Caption="Due Warehouse" FieldName="WarehouseDate" 
                             ReadOnly="True" VisibleIndex="21" Width="135px" Name="col_due_wh" 
                                 ExportWidth="75">
                             <PropertiesDateEdit DisplayFormatString="{0:d}" Spacing="0">
                            </PropertiesDateEdit>
                         </dx:GridViewDataDateColumn>
                         ...
                         <dx:GridViewDataTextColumn Caption="Unit price per copy" FieldName="UnitPricePerCopy" 
                             ReadOnly="True" VisibleIndex="22" Width="150px" 
                                 ExportWidth="50" Name="col_unitppc">
                         </dx:GridViewDataTextColumn>
                         
                          <dx:GridViewDataCheckColumn FieldName="JobClosed" VisibleIndex="23" 
                         ...
                         <dx:GridViewDataTextColumn FieldName="consignee_name" VisibleIndex="24" 
                           ...
                           <dx:GridViewDataTextColumn Caption="Impression" FieldName="Impression" ReadOnly="True" 
                            VisibleIndex="25" Width="100px" Name="col_impression" ExportWidth="70">
                            <Settings AutoFilterCondition="Contains" ShowFilterRowMenu="True" />
                        </dx:GridViewDataTextColumn>
                        
                        <dx:GridViewDataTextColumn Caption="Date order created" 
                               FieldName="DateOrderCreated" ReadOnly="True" 
                            VisibleIndex="26" Width="120px" Name="col_datecreated" ExportWidth="75" 
                               Visible="False">
                            <PropertiesTextEdit DisplayFormatString="{0:d}">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="orderid" FieldName="OrderID" 
                         ...
                         <dx:GridViewDataTextColumn Caption="Order Ix" FieldName="SubDeliveryID" 
                             Name="col_orderix" ReadOnly="True" VisibleIndex="-1" Visible="false"  
                         ...
                         <dx:GridViewDataTextColumn Caption="Title_ID" FieldName="TitleID" 
                             ...
                             <dx:GridViewDataTextColumn Caption="Documents" FieldName="document_folder" 
                                 ...
                                 VisibleIndex="-1" Width="0px" Visible="False" >
                                 <Settings AllowAutoFilter="False" AllowAutoFilterTextInputTimer="False" 
                                     AllowDragDrop="False" AllowGroup="False" AllowHeaderFilter="False" 
                                     AllowSort="False" ShowFilterRowMenu="False" ShowInFilterControl="False" />
                             </dx:GridViewDataTextColumn>
                           <dx:GridViewDataMemoColumn Caption="Remarks" ExportWidth="150" 
                               FieldName="RemarksToCustomer" ReadOnly="True" VisibleIndex="25" 
                               Width="150px">
             ...
             <Settings ShowGroupPanel="True" ShowHeaderFilterButton="True" ShowFilterBar="Visible" 
                        ...
                        ShowGroupedColumns="True" VerticalScrollableHeight="450" ShowVerticalScrollBar="true" 
                        VerticalScrollBarStyle="Standard" ShowTitlePanel="True"/>
        ...
        <Windows>
             ...
             <dx:PopupWindow ContentUrl="~/Popupcontrol/Op_Tracking_Demo1.htm" 
              ...
              <dx:PopupWindow ContentUrl="../Popupcontrol/order_file_manager.aspx" 
                 ...
                 HeaderText="File Manager" Height="650px" Modal="True" 
                 Width="750px">
                 <ContentCollection>
