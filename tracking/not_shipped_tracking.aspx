<%@ Page Language="C#" AutoEventWireup="true" CodeFile="not_shipped_tracking.aspx.cs" MasterPageFile="~/WWI_m1.master" Inherits="not_shipped_tracking" %>
...
<script type="text/javascript">
    ...
    function onGridInit(s, e) {
        grdNotShipped.PerformCallback('getdata');
    }
    ...
    function onGridClientSideClick(s, e) {
        if (e.item.name == "mnuFields") {
            ...
            if (grdNotShipped.IsCustomizationWindowVisible())
            { grdNotShipped.HideCustomizationWindow(); }
            else
            { grdNotShipped.ShowCustomizationWindow(); }
            mnuGrid1.GetItemByName(e.item.name).SetText(UpdateMenuText());
        }
    }
    
    function UpdateMenuText() {
        var text = grdNotShipped.IsCustomizationWindowVisible() ? "Hide" : "Show";
        text += " field chooser";
        return text;
    }
    //****
    ...
    function submit_batch_request() {
            if (!grdNotShipped.InCallback()) {
                grdNotShipped.PerformCallback('batchupdate');
            }
    }
    ...
    function btnmore_click(s, e) {
            ...
            if (!grdNotShipped.InCallback()) {
                ...
                if (user != 'You are not signed in') {
                    ...
                    popDefault.SetWindowContentUrl(window1, '../Popupcontrol/order_tracking_filter.aspx?src=not_shipped');
    ...
    // ]]>
        ...
        <div class="innertube">  <!-- just a container div --> 
            ...
            <div class="grid_wrap">       
            <!-- grid --->
              <dx:ASPxGridView ID="gridNotShipped" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                    CssPostfix="Office2010Blue" width="100%" 
                    ClientInstanceName="grdNotShipped" DataSourceID="LinqServerModeDeliveriesNotShipped" 
                     oncustomcallback="gridNotShipped_CustomCallback" 
                ondatabound="gridNotShipped_DataBound" 
                    oncustomunboundcolumndata="gridNotShipped_CustomUnboundColumnData" 
                    ...
                    <SettingsCookies Enabled="True" CookiesID="nystracking" />
    ...
    <dx:LinqServerModeDataSource ID="LinqServerModeDeliveriesNotShipped" runat="server" 
        ContextTypeName="linq.linq_view_deliveries_not_shippedDataContext" 
        TableName="view_deliveries_by_ets_no_vessel" />
    ...
    TypeName="DAL.Logistics.dbcustomfilterfieldcontroller">
     ...
     <dx:ASPxGridViewExporter ID="orderGridExport" runat="server" 
        GridViewID="gridNotShipped" ReportHeader="Exported search results" 
        Landscape="True">
