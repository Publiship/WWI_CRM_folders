<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="file_manager_all.aspx.cs" Inherits="file_manager_all" %>
        ...
        <div class="shadowPanel">
            ...
            <div style="float: right; padding-right: 10px; width: 120px">
                      <dx:ASPxButton ID="dxbtnfolders" runat="server" 
                                        ...
                                        ToolTip="Click here to hide folders" 
                                        EnableTheming="False"  
                                        Height="24px" 
                                 Text="Hide folders" 
                          ...
                          CausesValidation="False" onclick="dxbtnfolders_Click" Wrap="False">
                                       <Image Height="16px" Width="16px" AlternateText="Hide folders" 
