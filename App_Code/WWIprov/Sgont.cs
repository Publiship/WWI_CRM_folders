...
{
	/// <summary>
	/// Strongly-typed collection for the Sgont class.
	/// </summary>
    [Serializable]
	public partial class SgontCollection : ActiveList<Sgont, SgontCollection>
	{	   
		public SgontCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SgontCollection</returns>
		public SgontCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SGONT table.
	/// </summary>
	[Serializable]
	public partial class Sgont : ActiveRecord<Sgont>, IActiveRecord
	{
		...
		public Sgont(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Sgont(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SGONT", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("SGONT",schema);
			}
		}
		#endregion
