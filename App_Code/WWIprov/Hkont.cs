...
{
	/// <summary>
	/// Strongly-typed collection for the Hkont class.
	/// </summary>
    [Serializable]
	public partial class HkontCollection : ActiveList<Hkont, HkontCollection>
	{	   
		public HkontCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>HkontCollection</returns>
		public HkontCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the HKONT table.
	/// </summary>
	[Serializable]
	public partial class Hkont : ActiveRecord<Hkont>, IActiveRecord
	{
		...
		public Hkont(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Hkont(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("HKONT", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("HKONT",schema);
			}
		}
		#endregion
