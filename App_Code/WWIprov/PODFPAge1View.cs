...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the PODFPAge1View class.
    /// </summary>
    [Serializable]
    public partial class PODFPAge1ViewCollection : ReadOnlyList<PODFPAge1View, PODFPAge1ViewCollection>
    {        
        public PODFPAge1ViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the PODFPAge1View view.
    /// </summary>
    [Serializable]
    public partial class PODFPAge1View : ReadOnlyRecord<PODFPAge1View>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("PODFPAge1View", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("PODFPAge1View",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public PODFPAge1View()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public PODFPAge1View(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public PODFPAge1View(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public PODFPAge1View(string columnName, object columnValue)
        {
            SetSQLProps();
