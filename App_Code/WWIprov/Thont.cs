...
{
	/// <summary>
	/// Strongly-typed collection for the Thont class.
	/// </summary>
    [Serializable]
	public partial class ThontCollection : ActiveList<Thont, ThontCollection>
	{	   
		public ThontCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ThontCollection</returns>
		public ThontCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the THONT table.
	/// </summary>
	[Serializable]
	public partial class Thont : ActiveRecord<Thont>, IActiveRecord
	{
		...
		public Thont(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Thont(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("THONT", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("THONT",schema);
			}
		}
		#endregion
