...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the INfinitasReportView class.
    /// </summary>
    [Serializable]
    public partial class INfinitasReportViewCollection : ReadOnlyList<INfinitasReportView, INfinitasReportViewCollection>
    {        
        public INfinitasReportViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the INfinitasReportView view.
    /// </summary>
    [Serializable]
    public partial class INfinitasReportView : ReadOnlyRecord<INfinitasReportView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("INfinitasReportView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("INfinitasReportView",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public INfinitasReportView()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public INfinitasReportView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public INfinitasReportView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public INfinitasReportView(string columnName, object columnValue)
        {
            SetSQLProps();
