...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the InfintasOldJobsView class.
    /// </summary>
    [Serializable]
    public partial class InfintasOldJobsViewCollection : ReadOnlyList<InfintasOldJobsView, InfintasOldJobsViewCollection>
    {        
        public InfintasOldJobsViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the InfintasOldJobsView view.
    /// </summary>
    [Serializable]
    public partial class InfintasOldJobsView : ReadOnlyRecord<InfintasOldJobsView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("InfintasOldJobsView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("InfintasOldJobsView",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public InfintasOldJobsView()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public InfintasOldJobsView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public InfintasOldJobsView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public InfintasOldJobsView(string columnName, object columnValue)
        {
            SetSQLProps();
