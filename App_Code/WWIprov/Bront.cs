...
{
	/// <summary>
	/// Strongly-typed collection for the Bront class.
	/// </summary>
    [Serializable]
	public partial class BrontCollection : ActiveList<Bront, BrontCollection>
	{	   
		public BrontCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>BrontCollection</returns>
		public BrontCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the BRONT table.
	/// </summary>
	[Serializable]
	public partial class Bront : ActiveRecord<Bront>, IActiveRecord
	{
		...
		public Bront(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Bront(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("BRONT", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("BRONT",schema);
			}
		}
		#endregion
