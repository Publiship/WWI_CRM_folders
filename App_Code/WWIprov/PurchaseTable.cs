...
{
	/// <summary>
	/// Strongly-typed collection for the PurchaseTable class.
	/// </summary>
    [Serializable]
	public partial class PurchaseTableCollection : ActiveList<PurchaseTable, PurchaseTableCollection>
	{	   
		public PurchaseTableCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PurchaseTableCollection</returns>
		public PurchaseTableCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PurchaseTable o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PurchaseTable table.
	/// </summary>
	[Serializable]
	public partial class PurchaseTable : ActiveRecord<PurchaseTable>, IActiveRecord
	{
		...
		public PurchaseTable(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PurchaseTable(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PurchaseTable(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PurchaseTable", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				colvarPurchaseInvNumber.DataType = DbType.AnsiString;
				colvarPurchaseInvNumber.MaxLength = 255;
				...
				DataService.Providers["WWIprov"].AddSchema("PurchaseTable",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int? varInvoiceNumber,int? varSupplierID,decimal? varEstimatedAmount,DateTime? varEstimationDate,decimal? varAmount,DateTime? varDatePassed,string varPurchaseInvNumber,string varRemarks,decimal? varValueForProfit,byte[] varMstimestamp)
		{
		...
		/// </summary>
		public static void Update(int varId,int? varInvoiceNumber,int? varSupplierID,decimal? varEstimatedAmount,DateTime? varEstimationDate,decimal? varAmount,DateTime? varDatePassed,string varPurchaseInvNumber,string varRemarks,decimal? varValueForProfit,byte[] varMstimestamp)
		{
			PurchaseTable item = new PurchaseTable();
