...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the ContactView class.
    /// </summary>
    [Serializable]
    public partial class ContactViewCollection : ReadOnlyList<ContactView, ContactViewCollection>
    {        
        public ContactViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ContactView view.
    /// </summary>
    [Serializable]
    public partial class ContactView : ReadOnlyRecord<ContactView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ContactView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("ContactView",schema);
            }
        }
        #endregion
        ...
        public ContactView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ContactView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ContactView(string columnName, object columnValue)
        {
            SetSQLProps();
