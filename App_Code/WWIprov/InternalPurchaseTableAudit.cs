...
{
	/// <summary>
	/// Strongly-typed collection for the InternalPurchaseTableAudit class.
	/// </summary>
    [Serializable]
	public partial class InternalPurchaseTableAuditCollection : ActiveList<InternalPurchaseTableAudit, InternalPurchaseTableAuditCollection>
	{	   
		public InternalPurchaseTableAuditCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InternalPurchaseTableAuditCollection</returns>
		public InternalPurchaseTableAuditCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InternalPurchaseTableAudit o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InternalPurchaseTableAudit table.
	/// </summary>
	[Serializable]
	public partial class InternalPurchaseTableAudit : ActiveRecord<InternalPurchaseTableAudit>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InternalPurchaseTableAudit()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InternalPurchaseTableAudit(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InternalPurchaseTableAudit(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InternalPurchaseTableAudit(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InternalPurchaseTableAudit", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				TableSchema.TableColumn colvarPurchaseTableID = new TableSchema.TableColumn(schema);
				colvarPurchaseTableID.ColumnName = "PurchaseTableID";
				colvarPurchaseTableID.DataType = DbType.Int32;
				colvarPurchaseTableID.MaxLength = 0;
				colvarPurchaseTableID.AutoIncrement = false;
				colvarPurchaseTableID.IsNullable = true;
				colvarPurchaseTableID.IsPrimaryKey = false;
				colvarPurchaseTableID.IsForeignKey = true;
				colvarPurchaseTableID.IsReadOnly = false;
				colvarPurchaseTableID.DefaultSetting = @"";
				
					colvarPurchaseTableID.ForeignKeyTableName = "InternalPurchaseTabley";
				schema.Columns.Add(colvarPurchaseTableID);
				...
				DataService.Providers["WWIprov"].AddSchema("InternalPurchaseTableAudit",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("PurchaseTableID")]
		[Bindable(true)]
		public int? PurchaseTableID 
		{
			get { return GetColumnValue<int?>(Columns.PurchaseTableID); }
			set { SetColumnValue(Columns.PurchaseTableID, value); }
		}
		...
		/// <summary>
		/// Returns a InternalPurchaseTabley ActiveRecord object related to this InternalPurchaseTableAudit
		/// 
		/// </summary>
		public DAL.Logistics.InternalPurchaseTabley InternalPurchaseTabley
		{
			get { return DAL.Logistics.InternalPurchaseTabley.FetchByID(this.PurchaseTableID); }
			set { SetColumnValue("PurchaseTableID", value.Id); }
		}
		...
		/// </summary>
		public static void Update(int varPurchaseAuditIDa,int? varPurchaseTableID,int? varInvoiceNumber,int? varSupplierID,decimal? varEstimatedAmount,DateTime? varEstimationDate,string varOldValue,decimal? varAmount,DateTime? varDatePassed,string varPurchaseInvNumber,string varRemarks,decimal? varValueForProfit,DateTime? varAdded,int? varAddedBy,byte[] varTs)
		{
			InternalPurchaseTableAudit item = new InternalPurchaseTableAudit();
        ...
        public static TableSchema.TableColumn PurchaseTableIDColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string PurchaseTableID = @"PurchaseTableID";
