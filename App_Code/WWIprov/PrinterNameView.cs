...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the PrinterNameView class.
    /// </summary>
    [Serializable]
    public partial class PrinterNameViewCollection : ReadOnlyList<PrinterNameView, PrinterNameViewCollection>
    {        
        public PrinterNameViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the PrinterNameView view.
    /// </summary>
    [Serializable]
    public partial class PrinterNameView : ReadOnlyRecord<PrinterNameView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("PrinterNameView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("PrinterNameView",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public PrinterNameView()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public PrinterNameView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public PrinterNameView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public PrinterNameView(string columnName, object columnValue)
        {
            SetSQLProps();
