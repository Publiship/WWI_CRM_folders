...
namespace DAL.Logistics
{
    ...
    public partial class deliverysubsubtablecustomcontroller
    {
        // Preload our schema..
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public DeliverySubSubTableCollection FetchByDeliveryID(object DeliveryID)
        {
            DeliverySubSubTableCollection coll = new DeliverySubSubTableCollection().Where("DeliveryID", DeliveryID).Load();
            return coll;
        }
        /// <summary>
        ...
        {
            DeliverySubSubTable item = new DeliverySubSubTable(DeliveryID);
