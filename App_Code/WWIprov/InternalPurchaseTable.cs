...
{
	/// <summary>
	/// Strongly-typed collection for the InternalPurchaseTable class.
	/// </summary>
    [Serializable]
	public partial class InternalPurchaseTableCollection : ActiveList<InternalPurchaseTable, InternalPurchaseTableCollection>
	{	   
		public InternalPurchaseTableCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InternalPurchaseTableCollection</returns>
		public InternalPurchaseTableCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InternalPurchaseTable o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InternalPurchaseTable table.
	/// </summary>
	[Serializable]
	public partial class InternalPurchaseTable : ActiveRecord<InternalPurchaseTable>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InternalPurchaseTable()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InternalPurchaseTable(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InternalPurchaseTable(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InternalPurchaseTable(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		/// <summary>
		/// Returns a InternalInvoiceTable ActiveRecord object related to this InternalPurchaseTable
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int? varInvoiceNumber,int? varSupplierID,float? varEstimatedAmount,DateTime? varEstimationDate,float? varAmount,DateTime? varDatePassed,string varPurchaseInvNumber,string varRemarks,float? varValueForProfit)
		{
		...
		/// </summary>
		public static void Update(int varId,int? varInvoiceNumber,int? varSupplierID,float? varEstimatedAmount,DateTime? varEstimationDate,float? varAmount,DateTime? varDatePassed,string varPurchaseInvNumber,string varRemarks,float? varValueForProfit)
		{
			InternalPurchaseTable item = new InternalPurchaseTable();
