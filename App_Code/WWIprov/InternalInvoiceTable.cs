...
{
	/// <summary>
	/// Strongly-typed collection for the InternalInvoiceTable class.
	/// </summary>
    [Serializable]
	public partial class InternalInvoiceTableCollection : ActiveList<InternalInvoiceTable, InternalInvoiceTableCollection>
	{	   
		public InternalInvoiceTableCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InternalInvoiceTableCollection</returns>
		public InternalInvoiceTableCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InternalInvoiceTable o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InternalInvoiceTable table.
	/// </summary>
	[Serializable]
	public partial class InternalInvoiceTable : ActiveRecord<InternalInvoiceTable>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InternalInvoiceTable()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InternalInvoiceTable(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InternalInvoiceTable(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InternalInvoiceTable(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InternalInvoiceTable", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				colvarInsuranceValue.DataType = DbType.Single;
				...
				colvarOriginalProfitMargin.DataType = DbType.Single;
				...
				colvarConfirmedCompleted.DataType = DbType.Boolean;
				...
				DataService.Providers["WWIprov"].AddSchema("InternalInvoiceTable",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<float?>(Columns.InsuranceValue); }
		...
		[Bindable(true)]
		public float? OriginalProfitMargin 
		{
			get { return GetColumnValue<float?>(Columns.OriginalProfitMargin); }
		...
		[Bindable(true)]
		public bool? ConfirmedCompleted 
		{
			get { return GetColumnValue<bool?>(Columns.ConfirmedCompleted); }
		...
		{
			return new DAL.Logistics.InternalInvoiceSubTableCollection().Where(InternalInvoiceSubTable.Columns.InvoiceNumber, InvoiceNumber).Load();
		}
		public DAL.Logistics.InternalInvoiceTableAuditCollection InternalInvoiceTableAuditRecords()
		{
			return new DAL.Logistics.InternalInvoiceTableAuditCollection().Where(InternalInvoiceTableAudit.Columns.InvoiceNumber, InvoiceNumber).Load();
		}
		public DAL.Logistics.InternalPurchaseTableCollection InternalPurchaseTableRecords()
		{
			return new DAL.Logistics.InternalPurchaseTableCollection().Where(InternalPurchaseTable.Columns.InvoiceNumber, InvoiceNumber).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int? varOrderNumber,int? varDepartmentID,DateTime? varInvoiceDate,int? varCustomer,int? varInvoiceCurrencyID,string varDescription,float? varExchangeRate,string varNotes,DateTime? varPaymentDueDate,int? varInvoiceRaisedBy,DateTime? varInvoiceRaised,float? varInsuranceValue,string varContact,float? varOriginalProfitMargin,DateTime? varOriginalProfitDate,DateTime? varDateQueryRaised,string varDetailsOfQuery,string varResolution,bool? varConfirmedCompleted,DateTime? varCompletionDate,int? varController,byte[] varTs)
		{
		...
		/// </summary>
		public static void Update(int varInvoiceNumber,int? varOrderNumber,int? varDepartmentID,DateTime? varInvoiceDate,int? varCustomer,int? varInvoiceCurrencyID,string varDescription,float? varExchangeRate,string varNotes,DateTime? varPaymentDueDate,int? varInvoiceRaisedBy,DateTime? varInvoiceRaised,float? varInsuranceValue,string varContact,float? varOriginalProfitMargin,DateTime? varOriginalProfitDate,DateTime? varDateQueryRaised,string varDetailsOfQuery,string varResolution,bool? varConfirmedCompleted,DateTime? varCompletionDate,int? varController,byte[] varTs)
		{
			InternalInvoiceTable item = new InternalInvoiceTable();
