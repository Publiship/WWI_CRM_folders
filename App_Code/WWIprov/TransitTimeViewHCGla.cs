...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the TransitTimeViewHCGla class.
    /// </summary>
    [Serializable]
    public partial class TransitTimeViewHCGlaCollection : ReadOnlyList<TransitTimeViewHCGla, TransitTimeViewHCGlaCollection>
    {        
        public TransitTimeViewHCGlaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the TransitTimeViewHCGlas view.
    /// </summary>
    [Serializable]
    public partial class TransitTimeViewHCGla : ReadOnlyRecord<TransitTimeViewHCGla>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("TransitTimeViewHCGlas", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("TransitTimeViewHCGlas",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public TransitTimeViewHCGla()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public TransitTimeViewHCGla(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public TransitTimeViewHCGla(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public TransitTimeViewHCGla(string columnName, object columnValue)
        {
            SetSQLProps();
