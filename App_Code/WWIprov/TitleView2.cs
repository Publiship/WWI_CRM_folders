...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the TitleView2 class.
    /// </summary>
    [Serializable]
    public partial class TitleView2Collection : ReadOnlyList<TitleView2, TitleView2Collection>
    {        
        public TitleView2Collection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the TitleView2 view.
    /// </summary>
    [Serializable]
    public partial class TitleView2 : ReadOnlyRecord<TitleView2>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("TitleView2", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("TitleView2",schema);
            }
        }
        #endregion
        ...
        public TitleView2(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public TitleView2(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public TitleView2(string columnName, object columnValue)
        {
            SetSQLProps();
