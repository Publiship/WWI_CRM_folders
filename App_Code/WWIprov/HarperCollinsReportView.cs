...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the HarperCollinsReportView class.
    /// </summary>
    [Serializable]
    public partial class HarperCollinsReportViewCollection : ReadOnlyList<HarperCollinsReportView, HarperCollinsReportViewCollection>
    {        
        public HarperCollinsReportViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the HarperCollinsReportView view.
    /// </summary>
    [Serializable]
    public partial class HarperCollinsReportView : ReadOnlyRecord<HarperCollinsReportView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("HarperCollinsReportView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("HarperCollinsReportView",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public HarperCollinsReportView()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public HarperCollinsReportView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public HarperCollinsReportView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public HarperCollinsReportView(string columnName, object columnValue)
        {
            SetSQLProps();
