...
{
	/// <summary>
	/// Strongly-typed collection for the InternalInvoiceSubTableAudit class.
	/// </summary>
    [Serializable]
	public partial class InternalInvoiceSubTableAuditCollection : ActiveList<InternalInvoiceSubTableAudit, InternalInvoiceSubTableAuditCollection>
	{	   
		public InternalInvoiceSubTableAuditCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InternalInvoiceSubTableAuditCollection</returns>
		public InternalInvoiceSubTableAuditCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InternalInvoiceSubTableAudit o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InternalInvoiceSubTableAudit table.
	/// </summary>
	[Serializable]
	public partial class InternalInvoiceSubTableAudit : ActiveRecord<InternalInvoiceSubTableAudit>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InternalInvoiceSubTableAudit()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InternalInvoiceSubTableAudit(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InternalInvoiceSubTableAudit(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InternalInvoiceSubTableAudit(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InternalInvoiceSubTableAudit", TableType.Table, DataService.GetInstance("WWIprov"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarInternalInvoiceSubTableAuditID = new TableSchema.TableColumn(schema);
				colvarInternalInvoiceSubTableAuditID.ColumnName = "InternalInvoiceSubTableAuditID";
				colvarInternalInvoiceSubTableAuditID.DataType = DbType.Int32;
				colvarInternalInvoiceSubTableAuditID.MaxLength = 0;
				colvarInternalInvoiceSubTableAuditID.AutoIncrement = true;
				colvarInternalInvoiceSubTableAuditID.IsNullable = false;
				colvarInternalInvoiceSubTableAuditID.IsPrimaryKey = true;
				colvarInternalInvoiceSubTableAuditID.IsForeignKey = false;
				colvarInternalInvoiceSubTableAuditID.IsReadOnly = false;
				colvarInternalInvoiceSubTableAuditID.DefaultSetting = @"";
				colvarInternalInvoiceSubTableAuditID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarInternalInvoiceSubTableAuditID);
				
				TableSchema.TableColumn colvarInternalInvoiceSubTableID = new TableSchema.TableColumn(schema);
				colvarInternalInvoiceSubTableID.ColumnName = "InternalInvoiceSubTableID";
				colvarInternalInvoiceSubTableID.DataType = DbType.Int32;
				colvarInternalInvoiceSubTableID.MaxLength = 0;
				colvarInternalInvoiceSubTableID.AutoIncrement = false;
				colvarInternalInvoiceSubTableID.IsNullable = true;
				colvarInternalInvoiceSubTableID.IsPrimaryKey = false;
				colvarInternalInvoiceSubTableID.IsForeignKey = true;
				colvarInternalInvoiceSubTableID.IsReadOnly = false;
				colvarInternalInvoiceSubTableID.DefaultSetting = @"";
				
					colvarInternalInvoiceSubTableID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarInternalInvoiceSubTableID);
				...
				DataService.Providers["WWIprov"].AddSchema("InternalInvoiceSubTableAudit",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("InternalInvoiceSubTableAuditID")]
		[Bindable(true)]
		public int InternalInvoiceSubTableAuditID 
		{
			get { return GetColumnValue<int>(Columns.InternalInvoiceSubTableAuditID); }
			set { SetColumnValue(Columns.InternalInvoiceSubTableAuditID, value); }
		}
		  
		[XmlAttribute("InternalInvoiceSubTableID")]
		[Bindable(true)]
		public int? InternalInvoiceSubTableID 
		{
			get { return GetColumnValue<int?>(Columns.InternalInvoiceSubTableID); }
			set { SetColumnValue(Columns.InternalInvoiceSubTableID, value); }
		}
		...
		/// </summary>
		public static void Insert(int? varInternalInvoiceSubTableID,int? varInvoiceNumber,int? varChargeType,string varDetail,int? varOldValue,float? varNewValue,bool varVat,decimal? varVATAmount,DateTime? varDateAdded,int? varAddedBy,byte[] varTs)
		{
			InternalInvoiceSubTableAudit item = new InternalInvoiceSubTableAudit();
			
			item.InternalInvoiceSubTableID = varInternalInvoiceSubTableID;
		...
		/// </summary>
		public static void Update(int varInternalInvoiceSubTableAuditID,int? varInternalInvoiceSubTableID,int? varInvoiceNumber,int? varChargeType,string varDetail,int? varOldValue,float? varNewValue,bool varVat,decimal? varVATAmount,DateTime? varDateAdded,int? varAddedBy,byte[] varTs)
		{
			InternalInvoiceSubTableAudit item = new InternalInvoiceSubTableAudit();
			
				item.InternalInvoiceSubTableAuditID = varInternalInvoiceSubTableAuditID;
        ...
        public static TableSchema.TableColumn InternalInvoiceSubTableAuditIDColumn
        {
        ...
        public static TableSchema.TableColumn InternalInvoiceSubTableIDColumn
        {
		...
		{
			 public static string InternalInvoiceSubTableAuditID = @"InternalInvoiceSubTableAuditID";
			 public static string InternalInvoiceSubTableID = @"InternalInvoiceSubTableID";
