...
{
	/// <summary>
	/// Strongly-typed collection for the Nlont class.
	/// </summary>
    [Serializable]
	public partial class NlontCollection : ActiveList<Nlont, NlontCollection>
	{	   
		public NlontCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>NlontCollection</returns>
		public NlontCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the NLONT table.
	/// </summary>
	[Serializable]
	public partial class Nlont : ActiveRecord<Nlont>, IActiveRecord
	{
		...
		public Nlont(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Nlont(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("NLONT", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("NLONT",schema);
			}
		}
		#endregion
