...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the PearsonReportView class.
    /// </summary>
    [Serializable]
    public partial class PearsonReportViewCollection : ReadOnlyList<PearsonReportView, PearsonReportViewCollection>
    {        
        public PearsonReportViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the PearsonReportView view.
    /// </summary>
    [Serializable]
    public partial class PearsonReportView : ReadOnlyRecord<PearsonReportView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("PearsonReportView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("PearsonReportView",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public PearsonReportView()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public PearsonReportView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public PearsonReportView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public PearsonReportView(string columnName, object columnValue)
        {
            SetSQLProps();
