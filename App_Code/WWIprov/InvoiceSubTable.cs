...
{
	/// <summary>
	/// Strongly-typed collection for the InvoiceSubTable class.
	/// </summary>
    [Serializable]
	public partial class InvoiceSubTableCollection : ActiveList<InvoiceSubTable, InvoiceSubTableCollection>
	{	   
		public InvoiceSubTableCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InvoiceSubTableCollection</returns>
		public InvoiceSubTableCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InvoiceSubTable o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InvoiceSubTable table.
	/// </summary>
	[Serializable]
	public partial class InvoiceSubTable : ActiveRecord<InvoiceSubTable>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InvoiceSubTable()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InvoiceSubTable(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InvoiceSubTable(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InvoiceSubTable(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		{
			get { return GetColumnValue<double?>(Columns.VATAmount); }
		...
		public DAL.Logistics.InvoiceSubTableAuditCollection InvoiceSubTableAuditRecords()
		{
			return new DAL.Logistics.InvoiceSubTableAuditCollection().Where(InvoiceSubTableAudit.Columns.InvoiceSubTableID, EntryNumber).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int? varInvoiceNumber,int? varChargeType,string varDetail,decimal? varAmount,bool varVat,double? varVATAmount,byte[] varTs)
		{
		...
		/// </summary>
		public static void Update(int varEntryNumber,int? varInvoiceNumber,int? varChargeType,string varDetail,decimal? varAmount,bool varVat,double? varVATAmount,byte[] varTs)
		{
			InvoiceSubTable item = new InvoiceSubTable();
