...
{
	/// <summary>
	/// Strongly-typed collection for the CurrentStatus class.
	/// </summary>
    [Serializable]
	public partial class CurrentStatusCollection : ActiveList<CurrentStatus, CurrentStatusCollection>
	{	   
		public CurrentStatusCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CurrentStatusCollection</returns>
		public CurrentStatusCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CurrentStatus o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CurrentStatus table.
	/// </summary>
	[Serializable]
	public partial class CurrentStatus : ActiveRecord<CurrentStatus>, IActiveRecord
	{
		...
		public CurrentStatus(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CurrentStatus(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CurrentStatus(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CurrentStatus", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("CurrentStatus",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varField1,byte[] varTs)
		{
		...
		/// </summary>
		public static void Update(int varId,string varField1,byte[] varTs)
		{
			CurrentStatus item = new CurrentStatus();
