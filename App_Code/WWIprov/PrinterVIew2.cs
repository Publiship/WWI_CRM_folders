...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the PrinterVIew2 class.
    /// </summary>
    [Serializable]
    public partial class PrinterVIew2Collection : ReadOnlyList<PrinterVIew2, PrinterVIew2Collection>
    {        
        public PrinterVIew2Collection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the PrinterVIew2 view.
    /// </summary>
    [Serializable]
    public partial class PrinterVIew2 : ReadOnlyRecord<PrinterVIew2>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("PrinterVIew2", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("PrinterVIew2",schema);
            }
        }
        #endregion
        ...
        public PrinterVIew2(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public PrinterVIew2(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public PrinterVIew2(string columnName, object columnValue)
        {
            SetSQLProps();
