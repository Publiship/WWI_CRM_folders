...
namespace DAL.Logistics{
    /// <summary>
    /// Strongly-typed collection for the PearsonInvoiceView class.
    /// </summary>
    [Serializable]
    public partial class PearsonInvoiceViewCollection : ReadOnlyList<PearsonInvoiceView, PearsonInvoiceViewCollection>
    {        
        public PearsonInvoiceViewCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the PearsonInvoiceView view.
    /// </summary>
    [Serializable]
    public partial class PearsonInvoiceView : ReadOnlyRecord<PearsonInvoiceView>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("PearsonInvoiceView", TableType.View, DataService.GetInstance("WWIprov"));
                ...
                DataService.Providers["WWIprov"].AddSchema("PearsonInvoiceView",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public PearsonInvoiceView()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public PearsonInvoiceView(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public PearsonInvoiceView(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public PearsonInvoiceView(string columnName, object columnValue)
        {
            SetSQLProps();
