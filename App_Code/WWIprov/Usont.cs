...
{
	/// <summary>
	/// Strongly-typed collection for the Usont class.
	/// </summary>
    [Serializable]
	public partial class UsontCollection : ActiveList<Usont, UsontCollection>
	{	   
		public UsontCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>UsontCollection</returns>
		public UsontCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the USONT table.
	/// </summary>
	[Serializable]
	public partial class Usont : ActiveRecord<Usont>, IActiveRecord
	{
		...
		public Usont(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Usont(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("USONT", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("USONT",schema);
			}
		}
		#endregion
