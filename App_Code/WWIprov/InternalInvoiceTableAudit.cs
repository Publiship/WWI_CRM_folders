...
{
	/// <summary>
	/// Strongly-typed collection for the InternalInvoiceTableAudit class.
	/// </summary>
    [Serializable]
	public partial class InternalInvoiceTableAuditCollection : ActiveList<InternalInvoiceTableAudit, InternalInvoiceTableAuditCollection>
	{	   
		public InternalInvoiceTableAuditCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InternalInvoiceTableAuditCollection</returns>
		public InternalInvoiceTableAuditCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InternalInvoiceTableAudit o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InternalInvoiceTableAudit table.
	/// </summary>
	[Serializable]
	public partial class InternalInvoiceTableAudit : ActiveRecord<InternalInvoiceTableAudit>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InternalInvoiceTableAudit()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InternalInvoiceTableAudit(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InternalInvoiceTableAudit(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InternalInvoiceTableAudit(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InternalInvoiceTableAudit", TableType.Table, DataService.GetInstance("WWIprov"));
				...
				DataService.Providers["WWIprov"].AddSchema("InternalInvoiceTableAudit",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a InternalInvoiceTable ActiveRecord object related to this InternalInvoiceTableAudit
		/// 
		/// </summary>
