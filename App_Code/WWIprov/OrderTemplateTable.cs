...
{
	/// <summary>
	/// Strongly-typed collection for the OrderTemplateTable class.
	/// </summary>
    [Serializable]
	public partial class OrderTemplateTableCollection : ActiveList<OrderTemplateTable, OrderTemplateTableCollection>
	{	   
		public OrderTemplateTableCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OrderTemplateTableCollection</returns>
		public OrderTemplateTableCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OrderTemplateTable o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OrderTemplateTable table.
	/// </summary>
	[Serializable]
	public partial class OrderTemplateTable : ActiveRecord<OrderTemplateTable>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public OrderTemplateTable()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public OrderTemplateTable(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OrderTemplateTable(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OrderTemplateTable(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OrderTemplateTable", TableType.Table, DataService.GetInstance("WWIprov"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarOrderTemplateID = new TableSchema.TableColumn(schema);
				colvarOrderTemplateID.ColumnName = "OrderTemplateID";
				colvarOrderTemplateID.DataType = DbType.Int32;
				colvarOrderTemplateID.MaxLength = 0;
				colvarOrderTemplateID.AutoIncrement = true;
				colvarOrderTemplateID.IsNullable = false;
				colvarOrderTemplateID.IsPrimaryKey = true;
				colvarOrderTemplateID.IsForeignKey = false;
				colvarOrderTemplateID.IsReadOnly = false;
				colvarOrderTemplateID.DefaultSetting = @"";
				colvarOrderTemplateID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOrderTemplateID);
				...
				colvarPublishipOrder.DefaultSetting = @"";
				...
				DataService.Providers["WWIprov"].AddSchema("OrderTemplateTable",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OrderTemplateID")]
		[Bindable(true)]
		public int OrderTemplateID 
		{
			get { return GetColumnValue<int>(Columns.OrderTemplateID); }
			set { SetColumnValue(Columns.OrderTemplateID, value); }
		}
		...
		/// </summary>
		public static void Insert(string varTemplateName,string varOfficeIndicator,bool? varPublishipOrder,int? varCompanyID,int? varConsigneeID,int? varNotifyPartyID,int? varAgentAtOriginID,int? varAgentAtDestinationID,int? varPrinterID,int? varClearingAgentID,int? varOnCarriageID,int? varOrderControllerID,int? varOperationsControllerID,int? varOriginPortControllerID,int? varDestinationPortControllerID,string varCustomersRef,int? varContactID,int? varOriginPointID,int? varPortID,int? varDestinationPortID,int? varFinalDestinationID,int? varCountryID,int? varDestinationCountryID,byte[] varTs)
		{
		...
		/// </summary>
		public static void Update(int varOrderTemplateID,string varTemplateName,string varOfficeIndicator,bool? varPublishipOrder,int? varCompanyID,int? varConsigneeID,int? varNotifyPartyID,int? varAgentAtOriginID,int? varAgentAtDestinationID,int? varPrinterID,int? varClearingAgentID,int? varOnCarriageID,int? varOrderControllerID,int? varOperationsControllerID,int? varOriginPortControllerID,int? varDestinationPortControllerID,string varCustomersRef,int? varContactID,int? varOriginPointID,int? varPortID,int? varDestinationPortID,int? varFinalDestinationID,int? varCountryID,int? varDestinationCountryID,byte[] varTs)
		{
			OrderTemplateTable item = new OrderTemplateTable();
			
				item.OrderTemplateID = varOrderTemplateID;
        ...
        public static TableSchema.TableColumn OrderTemplateIDColumn
        {
		...
		{
			 public static string OrderTemplateID = @"OrderTemplateID";
