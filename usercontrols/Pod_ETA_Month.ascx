<%@ Control Language="C#" ClassName="PodEtaMonthWidget" AutoEventWireup="true" CodeFile="Pod_ETA_Month.ascx.cs" Inherits="usercontrols_Pod_ETA_Month" %>
...
<div>
    <dxchartsui:WebChartControl ID="dxchartEta" runat="server" 
        ...
        PaletteBaseColorNumber="6" PaletteName="Flow" 
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
   ...
   <div>
    <dx:ASPxLabel ID="dxlblerr2" ClientInstanceName="lblerr2" runat="server" 
