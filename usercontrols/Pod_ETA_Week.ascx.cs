...
public partial class usercontrols_Pod_ETA_Week : System.Web.UI.UserControl
{
    ...
    protected void bind_chart(Int32 companyid)
    {
        try
        {
            ...
            IDataReader _dr = _orders.GetOrderCountByEtaWeek(companyid);
        ...
        {
            this.dxlblerr3.Text = ex.Message.ToString();
            this.dxlblerr3.Visible = true;
        }
    }
    //end bind guage
}
