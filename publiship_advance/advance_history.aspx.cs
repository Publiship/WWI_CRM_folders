...
public partial class advance_history : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        //{
            ...
            //if (_intra == true)
            //{
            //    //Response.Redirect("~/Sys_Session_Login.aspx?" + "rp=" + wwi_security.EncryptString("Wbs_Pricer_Audit_2", "publiship")); 
            //
            //}
        //}
        //catch (Exception ex)
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (isLoggedIn())
        {
            ...
            {
                if (!Page.IsCallback) { Response.Redirect("~/publiship_advance/advance_audit.aspx", true); }
            }
        ...
        {
            if (!Page.IsPostBack) { Response.Redirect("../user_accounts/signin.aspx?" + "rp=" + wwi_security.EncryptString("publiship_advance/advance_history", "publiship")); }       
        }
    }
    ...
    protected void dxgrdorders_CustomButtonInitialize(object sender, ASPxGridViewCustomButtonEventArgs e)
    {
        ...
        if (_cid != -1)
        {
            ...
            //detailed edit button, external users get the standard form with restrictyed details not the whole lot
    ...
    {
        if (e.ButtonID != "cmdRemove") return;
