<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="order_template.aspx.cs" Inherits="order_template" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderM1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function onDestinationAgentSelected(s, e) {
            ...
            requeryDestinationController(s.GetValue().toString());
        }
        ...
        //company combo button click
        function onCountryButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                //clear text and clear client contact
                s.SetText('');
                s.SetSelectedIndex(-1);
                cboOriginPointID.SetText('');
                cboOriginPointID.SetSelectedIndex(-1);
                cboPortID.SetText('');
                cboPortID.SetSelectedIndex(-1);
                cboOriginPointID.SetText('');
        ...
        function onCompanyButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                ...
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblCompanyIDView.SetText('');
                cboContactID.SetText('');
                cboContactID.SetSelectedIndex(-1);
            }
        }

        function onOriginPointButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                //clear text and clear client contact
                s.SetText('');
                s.SetSelectedIndex(-1);
        ...
        function onAgentAtOriginButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                ...
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblAgentAtOriginIDView.SetText('');
                cboOriginPortControllerID.SetText('');
                cboOriginPortControllerID.SetSelectedIndex(-1);
                cboContactID.SetText('');
                cboContactID.SetSelectedIndex(-1);
            }
        }
        ...
        function onAgentAtDestinationButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                ...
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblAgentAtDestinationIDView.SetText('');
                cboDestinationPortControllerID.SetText('');
                cboDestinationPortControllerID.SetSelectedIndex(-1);
            }
        }
        ...
        function onPrinterButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                ...
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblPrinterIDView.SetText('');
            }
        }

        function onNotifyButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                //clear text and clear client contact
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblNotifyPartyIDView.SetText('');
            }
        }
        ...
        function onClearingAgentButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                ...
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblClearingAgentIDView.SetText('');
            }
        }

        function onCarriageArrangedByButtonClick(s, e) {
            if (e.buttonIndex == 0) {
                //clear text and clear client contact
                s.SetText('');
                s.SetSelectedIndex(-1);
                lblOnCarriageIDView.SetText('');
            }
        }
        //********************
        // ]]>
    ...
    <div class="container_16">
        ...
        <div class="grid_10">
            ...
            <div class="divleft">
            <dx:ASPxLabel ID="dxlblOrderTemplateID" runat="server" ClientInstanceName="lblOrderTemplateID" 
                             CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                             CssPostfix="Office2010Blue" Font-Size="X-Large">
                         </dx:ASPxLabel>
            </div> 
            ...
            <asp:FormView ID="fmvTemplate" runat="server" width="100%" 
                            ...
                            <tr class="row_divider">
                                    ...
                                    <td>
                                         <dx:ASPxTextBox ID="dxtxtTemplateName" runat="server" 
                                             ...
                                             CssPostfix="Office2010Blue" 
                                             SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                             Value='<%# Bind("TemplateName") %>' Width="200px">
                                         </dx:ASPxTextBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                               ...
                               <tr class="row_divider">
                                   ...
                                   <td>
                                       <dx:ASPxLabel ID="dxlblPublishipOrderView" runat="server" 
                                           ClientInstanceName="lblPublishipOrderView" 
                                           CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                           CssPostfix="Office2010Blue" Text="Publiship order">
                                       </dx:ASPxLabel>
                                   </td>
                                   <td>
                                       <dx:ASPxCheckBox ID="dxckbPublishipOrder" runat="server" CheckState="Unchecked" 
                                           ClientInstanceName="ckbPublishipOrder" 
                                           CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                           CssPostfix="Office2010Blue" 
                                           SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                               ...
                               <tr class="row_divider">
                                   ...
                                   <td>
                                    <dx:ASPxComboBox ID="dxcboContactID" runat="server" 
                                         ...
                                         ValueType="System.Int32" Width="200px" CallbackPageSize="25" 
                            ...
                            <tr class="row_divider">
                                ...
                                <td>
                                       <dx:ASPxComboBox ID="dxcboCountryID" runat="server" CallbackPageSize="15" 
                                         ...
                                         <ClientSideEvents ButtonClick="onCountryButtonClick" SelectedIndexChanged="function(s, e) { onCountryChanged(s, e); }" />
                                         <Buttons>
	                                        <dx:EditButton ToolTip="Click to remove name" Position="Left" >
      	                                        <Image Height="12px" Url="~/Images/icons/metro/delete2.png" Width="12px" >
      	                                        </Image>
                            ...
                            <tr class="row_divider">
                                ...
                                <td>
                                     <dx:ASPxComboBox ID="dxcboOriginPointID" runat="server" CallbackPageSize="15" 
                                         ...
                                         <ClientSideEvents ButtonClick="onOriginPointButtonClick" SelectedIndexChanged="function(s, e) { onOriginChanged(s); }" />
                                        <Buttons>
	                                        <dx:EditButton ToolTip="Click to remove name" Position="Left" >
      	                                        <Image Height="12px" Url="~/Images/icons/metro/delete2.png" Width="12px" >
      	                                        </Image>
                            ...
                            <tr class="row_divider">
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="dxcboNotifyPartyID" runat="server" CallbackPageSize="15" 
                                        ...
                                        ValueField="CompanyID" ValueType="System.Int32" Width="200px" 
                                        >
                                        <ClientSideEvents ButtonClick="onNotifyButtonClick" SelectedIndexChanged="function(s, e) {
                            ...
                            <tr class="row_divider">
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="dxcboOnCarriageID" runat="server" CallbackPageSize="15" 
                                        ...
                                        ValueField="CompanyID" ValueType="System.Int32" Width="200px" 
                                        >
                                        <ClientSideEvents ButtonClick="onCarriageArrangedByButtonClick" SelectedIndexChanged="function(s, e) {
                ...
                <table id="tblView" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                           <colgroup>
                            ...
                            <tr class="row_divider">
                                    <td>
                                        <dx:ASPxLabel ID="dxlblTemplateName" runat="server" 
                                            ClientInstanceName="lblTemplateName" 
                                            CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                            CssPostfix="Office2010Blue" Font-Bold="True" Text="Template name">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td>
                                        <dx:ASPxTextBox ID="dxtxtTemplateName" runat="server" 
                                            ...
                                            CssPostfix="Office2010Blue" 
                                            SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                            Text='<%# Bind("TemplateName") %>' Width="200px">
                                            <ValidationSettings>
                                        ...
                                        <dx:ASPxLabel ID="dxlblTemplateNameView" runat="server" 
                                            ClientInstanceName="lblTemplateNameView" 
                                            CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                            CssPostfix="Office2010Blue" Text='<%# Bind("TemplateName") %>'>
                                        </dx:ASPxLabel>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                               ...
                               <tr class="row_divider">
                                   ...
                                   <td>
                                       <dx:ASPxLabel ID="dxlblOfficeIndicatorName" runat="server" 
                                           ...
                                           CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                           CssPostfix="Office2010Blue" Text='<%# Bind("OfficeIndicator") %>'>
                                       </dx:ASPxLabel>
                                   </td>
                                   <td>
                                       <dx:ASPxLabel ID="dxlblPublishipOrderView" runat="server" 
                                   ...
                                   <td>
                                       <dx:ASPxLabel ID="dxlblCustomersRefName" runat="server" 
                                           ...
                                           CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                           CssPostfix="Office2010Blue" Text='<%# Bind("CustomersRef") %>'>
                                       </dx:ASPxLabel>
                                   </td>
                           </tr>
                               <tr class="row_divider">
                ...
                <InsertItemTemplate>
                     <table id="tblInsert" cellpadding="5px" border="0" width="100%" class="viewTable">
                           <colgroup>
                                <col class="caption10" />
                                <col />
                                <col class="caption10" />
