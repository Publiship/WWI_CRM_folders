<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="port.aspx.cs" Inherits="port" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderM1" Runat="Server">
    ...
    <div class="container_16">
        ...
        <div class="grid_10 pad_bottom">
              <div class="divleft">
                   <dx:ASPxHyperLink ID="dxlnkReturn" runat="server" 
                      ...
                      ImageWidth="26px" NavigateUrl="~/data_admin/port_search.aspx" 
        ...
        <!-- view form columns -->
        <div class="grid_10"> 
            <asp:FormView ID="fmvPort" runat="server" Width="100%" 
                Height="59px" 
                onmodechanging="fmvPort_ModeChanging" ondatabound="fmvPort_DataBound">
                 <EditItemTemplate>
                     <table id="tblEdit" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                                   <colgroup>
                                      ...
                                      <tr class="row_divider">
                                          <td>
                                              <dx:ASPxLabel ID="dxlblPortEdit" runat="server" 
                                                  ClientInstanceName="lblPortEdit" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" Text="Port">
                                              </dx:ASPxLabel>
                                          </td>
                                          <td>
                                              <dx:ASPxTextBox ID="dxtxtPortEdit" runat="server" 
                                                  ClientInstanceName="txtPortEdit" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" 
                                                  SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                                  Text="<%# Bind('PortName') %>" Width="250px" MaxLength="50">
                                              </dx:ASPxTextBox>
                                          </td>
                                    </tr>
                                      <tr class="row_divider">
                ...
                <ItemTemplate>
                    <table id="tblView" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                      <colgroup>
                          ...
                          <tr class="row_divider">
                            <td>
                                 <dx:ASPxLabel ID="dxlblPort" runat="server" 
                                       ClientInstanceName="lblPort" 
                                       CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                       CssPostfix="Office2010Blue" Text="Port">
                                   </dx:ASPxLabel>
                            </td>
                            <td>
                                <dx:ASPxLabel ID="dxlblPortView" runat="server" 
                                    ...
                                    CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                    CssPostfix="Office2010Blue" Value='<%# Bind("PortName") %>'>
                                </dx:ASPxLabel>
                            </td>
                          </tr>
                          <tr class="row_divider">
                ...
                <InsertItemTemplate>
                       <table id="tblInsert" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                                   <colgroup>
                                      ...
                                      <tr class="row_divider">
                                          <td>
                                              <dx:ASPxLabel ID="dxlblPortInsert" runat="server" 
                                                  ClientInstanceName="lblPortInsert" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" Text="Port">
                                              </dx:ASPxLabel>
                                          </td>
                                          <td>
                                              <dx:ASPxTextBox ID="dxtxtPortInsert" runat="server" 
                                                  ClientInstanceName="txtPortInsert" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" 
                                                  SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                                  Text="<%# Bind('PortName') %>" Width="250px" MaxLength="50">
