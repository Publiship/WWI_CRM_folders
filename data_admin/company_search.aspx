<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="company_search.aspx.cs" Inherits="company_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="CompanyID" VisibleIndex="0" Width="75px" 
                        Caption="ID" ReadOnly="True" Name="colCompanyID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Name" 
                        FieldName="CompanyName" VisibleIndex="2" 
                        Width="200px" ReadOnly="True" ExportWidth="200" Name="colCompanyName">
                    </dx:GridViewDataTextColumn>
                     <dx:GridViewDataTextColumn Caption="Address 1 " 
                        FieldName="Address1" VisibleIndex="3" 
                        Width="175px" ReadOnly="True" ExportWidth="175" Name="colAddress1">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Address 2" FieldName="Address2" VisibleIndex="4" 
                        Width="175px" ReadOnly="True" ExportWidth="175" Name="colAddress2">
                    </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Address 3" FieldName="Address3" 
                           ReadOnly="True" VisibleIndex="5" Width="175px" ExportWidth="175" 
                        Name="colAddress3">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Post code" FieldName="PostCode" 
                           ReadOnly="True" VisibleIndex="6" Width="80px" Name="colPostCode">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Tel" FieldName="TelNo" ReadOnly="True" 
                           VisibleIndex="7" Width="150px" ExportWidth="150" Name="colTelNo">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Fax" FieldName="FaxNo" ReadOnly="True" 
                           VisibleIndex="8" Width="150px" ExportWidth="150" Name="colFaxNo">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Country" FieldName="CountryName" 
                           VisibleIndex="9" Width="125px" Name="colCountryName">
                       </dx:GridViewDataTextColumn>
                </Columns>
                <StylesPager>
