...
public partial class package_type : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../user_accounts/signin.aspx?" + "rp=" + wwi_security.EncryptString("data_admin/package_type_search", "publiship"));
        }
    }
    ...
    protected void set_mode(string mode)
    {
        ...
        switch (mode)
        {
            case "Edit":
                {
                    this.fmvPackage.ChangeMode(FormViewMode.Edit);
            ...
            case "Insert":
                {
                    this.fmvPackage.ChangeMode(FormViewMode.Insert);
                    _menuitems.Add("Save");
                    _menuitems.Add("Close");
                    enable_menu_items(_menuitems);
                    break;
            ...
            case "ReadOnly":
                {
                    this.fmvPackage.ChangeMode(FormViewMode.ReadOnly);
                    _menuitems.Add("Edit");
                    _menuitems.Add("Close");
                    enable_menu_items(_menuitems);
                    break;
            ...
            case "cmdSave":
                {
                    ...
                    int _newid = insert_package_type();
                    if (_newid > 0)
                    {
                        //set_mode("ReadOnly");
                        //call databind to change mode
    ...
    protected void bind_countries()
    {
        ...
        ASPxComboBox _dxcboCountry = (ASPxComboBox)this.fmvPackage.FindControl("dxcboCountry");
