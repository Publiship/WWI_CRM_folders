...
public partial class country : System.Web.UI.Page
{
    ...
    protected void set_mode(string mode)
    {
        ...
        switch (mode)
        {
            case "Edit":
                {
                    this.fmvCountry.ChangeMode(FormViewMode.Edit);
            ...
            case "Insert":
                {
                    this.fmvCountry.ChangeMode(FormViewMode.Insert);
                    _menuitems.Add("Save");
                    _menuitems.Add("Close");
                    enable_menu_items(_menuitems);
                    break;
            ...
            case "ReadOnly":
                {
                    this.fmvCountry.ChangeMode(FormViewMode.ReadOnly);
                    _menuitems.Add("Edit");
                    _menuitems.Add("Close");
                    enable_menu_items(_menuitems);
                    break;
    ...
    protected void fmvCountry_ModeChanging(object sender, FormViewModeEventArgs e)
    {
        this.fmvCountry.ChangeMode(e.NewMode);
    }
