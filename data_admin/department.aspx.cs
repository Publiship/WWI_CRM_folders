...
public partial class department : System.Web.UI.Page
{
    ...
    protected void set_mode(string mode)
    {
        ...
        switch (mode)
        {
            case "Edit":
                {
                    this.fmvDepartment.ChangeMode(FormViewMode.Edit);
            ...
            case "Insert":
                {
                    this.fmvDepartment.ChangeMode(FormViewMode.Insert);
                    _menuitems.Add("Save");
                    _menuitems.Add("Close");
                    enable_menu_items(_menuitems);
                    break;
            ...
            case "ReadOnly":
                {
                    this.fmvDepartment.ChangeMode(FormViewMode.ReadOnly);
                    _menuitems.Add("Edit");
                    _menuitems.Add("Close");
                    enable_menu_items(_menuitems);
                    break;
