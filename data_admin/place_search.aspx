<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="place_search.aspx.cs" Inherits="place_search" %>
        ...
        <div class="grid_10 pad_bottom">
            <div class="divleft">
                <dx:ASPxLabel ID="dxlblContainerDetails" runat="server" 
                    ...
                    Text="Search Origin and Destination points">
                         </dx:ASPxLabel>
            </div> 
            <div class="divleft">
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="PlaceID" 
                        ReadOnly="True" VisibleIndex="0" Width="75px" Caption="ID" Name="colPlaceID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Place name" 
                        FieldName="PlaceName" VisibleIndex="1" 
                        Width="275px" ReadOnly="True" Name="colPlaceName">
                    </dx:GridViewDataTextColumn>
                     <dx:GridViewDataTextColumn Caption="Country" 
                        FieldName="CountryName" VisibleIndex="3" 
                        Width="150px" ReadOnly="True" Name="colCountryName">
                    </dx:GridViewDataTextColumn>
                </Columns>
                <StylesPager>
