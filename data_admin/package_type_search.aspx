<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="package_type_search.aspx.cs" Inherits="package_type_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="PackageTypeID" 
                        ReadOnly="True" VisibleIndex="0" Width="75px" Caption="ID" 
                           Name="colPackageTypeID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Package Type" 
                        FieldName="PackageType" VisibleIndex="2" 
                        Width="275px" ReadOnly="True" Name="colPackageType">
                    </dx:GridViewDataTextColumn>
                </Columns>
                <StylesPager>
