<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="department_search.aspx.cs" Inherits="department_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="DepartmentID" 
                        ReadOnly="True" VisibleIndex="0" Width="75px" Caption="ID" Name="colDepartmentID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Department" 
                        FieldName="Department" VisibleIndex="1" 
                        Width="275px" ReadOnly="True" Name="colDepartment">
                    </dx:GridViewDataTextColumn>
                </Columns>
                <StylesPager>
