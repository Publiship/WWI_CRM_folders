<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="port_search.aspx.cs" Inherits="port_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="PortID" 
                        ReadOnly="True" VisibleIndex="0" Width="75px" Caption="ID" Name="colPortID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Port name" 
                        FieldName="PortName" VisibleIndex="1" 
                        Width="275px" ReadOnly="True" Name="colPortName">
                    </dx:GridViewDataTextColumn>
