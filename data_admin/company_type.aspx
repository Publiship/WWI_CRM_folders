<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="company_type.aspx.cs" Inherits="company_type" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderM1" Runat="Server">
    ...
    <div class="container_16">
        ...
        <div class="grid_10 pad_bottom">
              <div class="divleft">
                   <dx:ASPxHyperLink ID="dxlnkReturn" runat="server" 
                      ...
                      ImageWidth="26px" NavigateUrl="~/data_admin/company_type_search.aspx" 
        ...
        <!-- view form columns -->
        <div class="grid_10"> 
            <asp:FormView ID="fmvCompanyType" runat="server" Width="100%" 
                Height="59px" 
                onmodechanging="fmvCompanyType_ModeChanging">
                 <EditItemTemplate>
                     <table id="tblEdit" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                                   <colgroup>
                                      ...
                                      <tr class="row_divider">
                                          <td>
                                              <dx:ASPxLabel ID="dxlblTypeNameEdit" runat="server" 
                                                  ClientInstanceName="lblTypeNameEdit" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" Text="Company type">
                                              </dx:ASPxLabel>
                                          </td>
                                          <td>
                                              <dx:ASPxTextBox ID="dxtxtTypeNameEdit" runat="server" 
                                                  ClientInstanceName="txtTypeNameEdit" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" 
                                                  SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                                  Text="<%# Bind('TypeName') %>" Width="250px" MaxLength="50">
                                              </dx:ASPxTextBox>
                                          </td>
                                    </tr>
                                      <tr class="row_divider">
                ...
                <ItemTemplate>
                    <table id="tblView" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                      <colgroup>
                          ...
                          <tr class="row_divider">
                            <td>
                                 <dx:ASPxLabel ID="dxlblTypeName" runat="server" 
                                       ClientInstanceName="lblTypeName" 
                                       CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                       CssPostfix="Office2010Blue" Text="Company type" Wrap="True">
                                   </dx:ASPxLabel>
                            </td>
                            <td>
                                <dx:ASPxLabel ID="dxlblTypeNameView" runat="server" 
                                    ClientInstanceName="lblTypeNameView" 
                                    CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                    CssPostfix="Office2010Blue" Value='<%# Bind("TypeName") %>'>
                                </dx:ASPxLabel>
                            </td>
                          </tr>
                        <tr class="row_divider">
                ...
                <InsertItemTemplate>
                       <table id="tblInsert" cellpadding="5px" border="0" width="100%" class="viewTable fixed_layout">
                                   <colgroup>
                                      ...
                                      <tr class="row_divider">
                                          <td>
                                              <dx:ASPxLabel ID="dxlblTypeNameInsert" runat="server" 
                                                  ClientInstanceName="lblTypeNameInsert" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" Text="Company type">
                                              </dx:ASPxLabel>
                                          </td>
                                          <td>
                                              <dx:ASPxTextBox ID="dxtxtTypeNameInsert" runat="server" 
                                                  ClientInstanceName="txtTypeNameInsert" 
                                                  CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                  CssPostfix="Office2010Blue" 
                                                  SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                                  Text="<%# Bind('TypeName') %>" Width="250px" MaxLength="50">
