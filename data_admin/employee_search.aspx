<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="employee_search.aspx.cs" Inherits="employee_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="EmployeeID" VisibleIndex="1" Width="75px" Caption="ID" 
                           Name="colEmployeeID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Name" 
                        FieldName="Name" VisibleIndex="1" 
                        Width="200px" Name="colName" ExportWidth="200">
                    </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Department" ExportWidth="125" 
                           FieldName="Department" Name="colDepartment" VisibleIndex="3" 
                         Width="125px">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Office" ExportWidth="125" 
                           FieldName="OfficeName" Name="colOffice" VisibleIndex="4" Width="125px">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn Caption="Email address" ExportWidth="200" 
                           FieldName="EmailAddress" Name="colEmailAddress" VisibleIndex="5" Width="200px">
                       </dx:GridViewDataTextColumn>
                       <dx:GridViewDataCheckColumn Caption="Live" ExportWidth="60" FieldName="Live" 
                           Name="colLive" VisibleIndex="6" Width="60px">
