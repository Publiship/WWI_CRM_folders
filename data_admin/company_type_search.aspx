<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="company_type_search.aspx.cs" Inherits="company_type_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="TypeID" 
                        ReadOnly="True" VisibleIndex="0" Width="75px" Caption="ID" Name="colTypeID">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Company type" 
                        FieldName="TypeName" VisibleIndex="1" 
                        Width="275px" ReadOnly="True" Name="colTypeName">
                    </dx:GridViewDataTextColumn>
                </Columns>
                <StylesPager>
