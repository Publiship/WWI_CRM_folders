<%@ Page Title="" Language="C#" MasterPageFile="~/WWI_m1.master" AutoEventWireup="true" CodeFile="country_search.aspx.cs" Inherits="country_search" %>
        ...
        <!-- search grid -->
            <dx:ASPxGridView ID="dxgridSearch" ClientInstanceName="gridSearch" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="countryid" 
                        ReadOnly="True" VisibleIndex="1" Width="75px" Caption="ID" 
                         Name="colcountryid">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Name" 
                        FieldName="countryname" VisibleIndex="2" 
                        Width="300px" ReadOnly="True" Name="colcountryname">
                    </dx:GridViewDataTextColumn>
                     <dx:GridViewDataTextColumn Caption="ISO code" FieldName="isocode" 
                        ReadOnly="True" VisibleIndex="3" Width="100px" Name="colisocode">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn Caption="EU" FieldName="eu" ReadOnly="True" 
                        VisibleIndex="4" Width="75px" Name="coleu">
