<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wbs_Pricer_Print.aspx.cs" Inherits="Wbs_Pricer_Print" %>
    ...
    <script type="text/javascript">
        ...
        function btnredirect_click(s, e) {
            ...
            if (!dxgridviewPrices1.InCallback()) {
                ...
                user = verify_user();
                if (user != 'You are not logged in') {
                    self.location = "Ord_View_Tracking_Audit.aspx";
                }
                else {
                    var window = popDefault.GetWindowByName('msgform');
                    popDefault.ShowWindow(window);
...
<body>
        ...
        <div>  <!-- just a container div --> 
            ...
            <!-- end centered box -->
             ...
             <dx:ASPxButton ID="dxbtnclose" ClientInstanceName="btnclose" runat="server" 
                  Text="Cancel" CssFilePath="~/App_Themes/Office2003Blue/{0}/styles.css" 
                  CssPostfix="Office2003Blue" 
                  SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css" 
	...
	window.parent.popPricer.HideWindow(window.parent.popPricer.GetWindowByName('printpricer'));
}" />
            </dx:ASPxButton>   
        </div>  
            ...
            <dx:ASPxGridView ID="gridviewPrices1" runat="server" 
                ...
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="quote_Id" Name="colquoteid" 
                        VisibleIndex="0" Caption="Quote #" ReadOnly="true" width="90px" 
                        ExportWidth="50">
                    ...
                    <dx:GridViewDataTextColumn FieldName="book_title" Name="booktitle" 
                        VisibleIndex="2" Caption="Title or description" ReadOnly="true" 
                        Width="162px" ExportWidth="75">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn FieldName="request_date" Name="colrequestdate" 
                        VisibleIndex="3" Caption="Date" ReadOnly="true" Width="85px" 
                        Visible="False" ExportWidth="80">
                        <PropertiesDateEdit Spacing="0">
                        </PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="in_description" Name="colindescription" 
                        VisibleIndex="4" Caption="Input type" ReadOnly="true" Width="150px" 
                        ExportWidth="75">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="in_length" VisibleIndex="5" 
                        Caption="Length" ReadOnly="true" Width="80px" Name="col_length" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="in_width" VisibleIndex="6" 
                        Caption="Width" ReadOnly="true" Width="80px" Name="colwidth" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="in_depth" VisibleIndex="7" 
                        Caption="Depth" ReadOnly="true" Width="80px" Name="coldepth" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="in_weight" VisibleIndex="8" 
                        Caption="Weight" ReadOnly="true" Width="80px" Name="colweight" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="in_extent" VisibleIndex="9" 
                        Caption="Paper type and extent" ReadOnly="true" Width="140px" 
                        Name="colextent" ExportWidth="75">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="in_papergsm" VisibleIndex="10" 
                        Caption="Paper type gsm" ReadOnly="true" Width="100px" Name="colgsm" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn FieldName="in_hardback" VisibleIndex="11" 
                        Caption="Hardback" ReadOnly="true" Width="80px" Name="colhardback" 
                        ExportWidth="25">
                    ...
                    <dx:GridViewDataTextColumn FieldName="copies_carton" VisibleIndex="12" 
                        Caption="Copies per carton" ReadOnly="true" Width="110px" Name="colcarton" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="origin_name" VisibleIndex="13" 
                        Caption="Origin" ReadOnly="true" Width="150px" Name="colorigin" 
                        ExportWidth="75">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="country_name" VisibleIndex="14" 
                        Caption="Country" ReadOnly="true" Width="120px" Name="colcountry" 
                        ExportWidth="75">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="final_name" VisibleIndex="16" 
                        Caption="Final destination" ReadOnly="true" Width="120px" Name="colfinal" 
                        ExportWidth="80">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="tot_copies" VisibleIndex="17" 
                        Caption="Total copies" ReadOnly="true" Width="100px" Name="coltotcopies" 
                        ExportWidth="50">
                    </dx:GridViewDataTextColumn>
                      <dx:GridViewDataTextColumn Caption="Per copy price" FieldName="price_client" 
                             ReadOnly="True" VisibleIndex="18" Width="100px" ExportWidth="50">
                             <PropertiesTextEdit DisplayFormatString="{0:0.##}">
                             </PropertiesTextEdit>
                             <EditFormSettings Visible="False" />    
                         </dx:GridViewDataTextColumn>
                     <dx:GridViewDataTextColumn FieldName="in_currency" Name="incurrency" 
                        VisibleIndex="19" Caption="Currency" ReadOnly="true" Width="125px" 
                        ExportWidth="75">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="ship_via" VisibleIndex="20" 
                        Caption="Shipping via" ReadOnly="true" Width="120px" Name="colvia" 
                        Visible="False" ExportWidth="0">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="pallet_type" VisibleIndex="21"  
                        Caption="Pallet type" ReadOnly="true" Width="100px" Name="colpallet" 
                        Visible="False" ExportWidth="0" >
                    </dx:GridViewDataTextColumn>
                </Columns>
