<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order_tracking_filter.aspx.cs" Inherits="Popupcontrol_order_tracking_filter" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function onfieldnamechanged(s, e) {
            //save field and force criteria combo to refresh
            hfparam.Set("fname", s.GetValue().toString());
            //cbocrits.PerformCallback(cboadvfield.GetValue().toString());
            cbocrits.PerformCallback(s.GetValue().toString());
        }
     ...
     <asp:ScriptManager ID="scm_filter" runat="server" />
                ...
                <tr>
                    <td style="width: 150px" >
                       <dx:ASPxComboBox ID="dxcboadvfields" runat="server" ClientInstanceName="cboadvfields" 
                            ...
                            CssPostfix="Office2010Blue"  Width="144px" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                            ToolTip="Pick what you want to search for here e.g. ISBN number" 
                            TabIndex="1" TextField="FilterCaption" 
                            ValueField="FieldName" Spacing="0" 
                            DataSourceID="ObjectDataSourceAdvFields">
                    ...
                    <td style="width: 150px" >
                        <dx:ASPxComboBox ID="dxcbocrits" runat="server" ClientInstanceName="cbocrits" 
                            oncallback="dxcbocrits_Callback" 
                            CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                            CssPostfix="Office2010Blue" 
                            SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                            TextField="CAPTION" ValueField="LINQ" Width="145px" 
                            EnableSynchronization="False" Spacing="0">
                            <ButtonStyle Width="13px">
                            </ButtonStyle>
                            <LoadingPanelStyle ImageSpacing="5px">
                            </LoadingPanelStyle>
                                ...
                                <dx:ASPxPanel ID="dxpanel3" runat="server" Width="115px" ClientInstanceName="pnlvalue3">
                                    ...
                                    <dx:ASPxDateEdit ID="dxdtvalue1" ClientInstanceName="dtvalue1" runat="server" 
                                        NullText="Enter a date" 
                                            ...
                                            CssPostfix="Office2010Blue" 
                                            SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                            Width="112px" DisplayFormatString="{0:d}" Spacing="0">
                                        <CalendarProperties>
                                ...
                                <dx:ASPxPanel ID="dxpanel4" runat="server" Width="130px" ClientInstanceName="pnlvalue4">
                                    ...
                                    <dx:ASPxDateEdit ID="dxdtvalue2" ClientInstanceName="dtvalue2" runat="server" 
                                        NullText="And another date" Width="122px" 
                                            ...
                                            CssPostfix="Office2010Blue" 
                                            SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" 
                                            DisplayFormatString="{0:d}" Spacing="0">
                                        <CalendarProperties>
                                            <HeaderStyle Spacing="1px" />
                                        </CalendarProperties>
                                        <ButtonStyle Width="13px">
                                ...
                                <dx:ASPxPanel ID="dxpanel5" runat="server" Width="90px" ClientInstanceName="pnlvalue5">
                                    ...
                                    <dx:PanelContent ID="PanelContent5" runat="server">
                                       <dx:ASPxComboBox ID="dxcboyesno" ClientInstanceName="cboyesno" runat="server" 
                                            ...
                                            CssPostfix="Office2010Blue" 
                                            SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" Spacing="0">
                                           <LoadingPanelImage Url="~/App_Themes/Office2010Blue/Editors/Loading.gif">
                                           </LoadingPanelImage>
                                           <LoadingPanelStyle ImageSpacing="5px">
                                           </LoadingPanelStyle>
                                       ...
                                       <div style="float: left; width: 70px">
                                        ...
                                        <div style="float: left">
                                            <dx:ASPxLabel ID="dxlbldays" ClientInstanceName="lbldays" runat="server" 
                                                Text=" days" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                                CssPostfix="Office2010Blue">
                                            </dx:ASPxLabel>
                                        </div>
                                    </dx:PanelContent> 
                        ...
                        <asp:Repeater ID="rptfilter" runat="server" 
                            ...
                            <ItemTemplate>
                               <table> <!-- forces data into rows -->
                                ...
                                <dx:ASPxLabel ID="dxlblfield"  runat="server" 
                                        Text='<%# DataBinder.Eval(Container.DataItem,"fieldcaption").ToString() %>' 
                                        CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                        CssPostfix="Office2010Blue">
                                </dx:ASPxLabel>
                                </td> 
                                <td style="width: 200px">
                                <dx:ASPxLabel ID="dxlblcriteria" runat="server" 
                                        Text='<%# DataBinder.Eval(Container.DataItem,"criteriacaption").ToString() %>' 
                                        CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                        CssPostfix="Office2010Blue">
                                </dx:ASPxLabel>
                                </td> 
                                <td style="width: 300px">
                                <dx:ASPxLabel ID="dxlblvalue" runat="server" 
                                        Text='<%# DataBinder.Eval(Container.DataItem,"values").ToString() %>' 
                                        CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                        CssPostfix="Office2010Blue">
                                </dx:ASPxLabel>
                                </td> 
                                <td style="width: 15px">
                                <dx:ASPxLabel ID="dxtxtfilter" ClientVisible="False" runat="server" 
                                        Text='<%# DataBinder.Eval(Container.DataItem,"criteria").ToString() %>' 
                                        CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                                        CssPostfix="Office2010Blue">
                                </dx:ASPxLabel>
                                </td> 
        ...
        <div class="formcenter580"> 
             <div class="cell580_40">
                    <dx:ASPxLabel ID="aspxlblName" runat="server" 
                        Text="Name this search for future reference" 
                        CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" 
                        CssPostfix="Office2010Blue">
                    </dx:ASPxLabel> 
                    </div>
             ...
             <div class="cell580_20">
                 <dx:ASPxCheckBox ID="dxckReport" runat="server" 
                     ...
                     Visible="False" CheckState="Unchecked">
                 </dx:ASPxCheckBox>
             </div>
             <div class="cell580_20">
...
window.parent.popDefault.HideWindow(window.parent.popDefault.GetWindowByName('filterform'));}" />
             ...
             <div class="cell580_20">
                          <dx:ASPxButton ID="btnReset" runat="server" 
                            CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css" CssPostfix="Office2010Blue" 
                            SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css" Text="Reset all" 
                            Width="100px" CausesValidation="False" 
                            AutoPostBack="False">
                            <ClientSideEvents 
                                Click="function(s, e) {
killfilters();
        ...
        <div>
                  ...
                  <asp:ObjectDataSource ID="ObjectDataSourceAdvFields" runat="server" 
                                OldValuesParameterFormatString="" SelectMethod="FetchBySourceForm" 
                                TypeName="DAL.Logistics.dbcustomfilterfieldcontroller">
                      <SelectParameters>
                          <asp:QueryStringParameter Name="sourceform" QueryStringField="src" 
                              Type="String" />
                      </SelectParameters>
